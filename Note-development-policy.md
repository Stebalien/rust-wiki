# Rust Community Participation Guidelines
...
For real time discussions, we have a family of IRC channels on irc.mozilla.org:

* #rust -- general questions
* #rust-internals -- compiler developement
* #cargo -- the package manager
* #servo -- web browser development
* #rust-gamedev -- video game developement
* #rust-osdev -- defeloping operating systems in rust
* #rust-webdev -- rust and the world wide web
* #rust-apidesign -- designing beutiful APIs in rust.

#### Forums

We have two discourse forums for asynchrounous discussion:

* [users.rust-lang.org](http://users.rust-lang.org) -- for general rust-related discussions.
* [internals.rust-lang.org](http://internals.rust-lang.org) -- for discussing the design and implementation of the rust language and its standard library.

#### Reddit

We have a few subreddits for discussing rust:

* [/r/rust](https://www.reddit.com/r/rust) -- general rust discussions, project announcements, and blog posts.
* [/r/rust_gamedev](https://www.reddit.com/r/rust_gamedev) -- discussing game developement in rust.

#### Q&A

For general Q/A, you might consider heading over to [StackOverflow](https://stackoverflow.com/questions/tagged/rust).

### Guidelines

In _all_ contexts, please follow the conduct guidelines below. Language issues are often contentious and we'd like to keep discussion brief, civil and focused on what we're actually doing, not wandering off into too much imaginary stuff.
...
_TODO: This section needs a little work_
